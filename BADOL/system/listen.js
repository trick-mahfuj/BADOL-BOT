...
const logger = require("../catalogs/BADOLc.js");
...
console.log(`${crayon(``)}${sky(`• BADOL DATA •`)} - bot name : ${chalk.blueBright((!global.config.BOTNAME) ? "BADOL" : global.config.BOTNAME)} \n${sky(`• BADOL DATA •`)} - bot id : ${chalk.blueBright(api.getCurrentUserID())} \n${sky(`• BADOL DATA •`)} - bot prefix : ${chalk.blueBright(global.config.PREFIX)}\n${sky(`• BADOL DATA •`)} - deployed ${chalk.blueBright(operator)} bot operators and ${chalk.blueBright(admin)} admins`);
if (global.config.approval) {
  console.log(`${sky(`• BADOL DATA •`)} - deployed ${chalk.blueBright(approved)} approved groups`)
} 
if (global.config.premium) {
  console.log(`${sky(`• BADOL DATA •`)} - deployed ${chalk.blueBright(premium)} premium users`)
}
